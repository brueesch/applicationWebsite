...
public class SpeechRecognizer {
	...
	private static final String GRAMMAR_PATH = "resource:/edu/cmu/sphinx/cockpit/dialogs/";
	...
	public static int oneCommand = 0;
	...
	private void recognizerCockpit(LiveSpeechRecognizer recognizer) {
		...
		Main.outputArea.append("Example: flaps up / flaps down \n");
		Main.outputArea.append("To exit say \"exit\"\n");
		Main.outputArea.append("-------------------------------\n");
